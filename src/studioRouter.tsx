...
import { StoriesTab } from '@/components/studio/StoriesTab/StoriesTab';
import { Toaster } from '@/components/studio/ui/toaster';
import { VoicesTab } from '@/components/studio/VoicesTab/VoicesTab';
...
// Create router
export const studioRouter = createRouter({ routeTree });
