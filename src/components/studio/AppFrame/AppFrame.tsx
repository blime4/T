...
import { TitleBarDragRegion } from '@/components/studio/TitleBarDragRegion';
import { AudioPlayer } from '@/components/studio/AudioPlayer/AudioPlayer';
import { StoryTrackEditor } from '@/components/studio/StoriesTab/StoryTrackEditor';
import { TOP_SAFE_AREA_PADDING } from '@/lib/constants/ui';
import { cn } from '@/lib/utils/cn';
import { useStoryStore } from '@/stores/studio/storyStore';
